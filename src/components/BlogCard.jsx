  ...
  return (
    <div className="w-[333px] flex-grow pb-5 rounded-md dark:bg-zinc-900 bg-gray-200">
        ...
        <div className="flex flex-col gap-3 items-center mt-5 px-2">
            <p className="text-base dark:text-white text-zinc-900 w-full text-center font-semibold">Post ID ({post.id})</p>
            <p className="text-base dark:text-white text-zinc-900 w-full text-center font-medium capitalize">{post.tags.join(' | ')}</p>
            <Link to={`/post/${post.id}`}>
